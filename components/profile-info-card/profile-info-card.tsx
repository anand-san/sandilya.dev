...
export const ProfileInfoCard = () => {
  ...
  return (
    <section className="grid md:grid-cols-[2fr,1fr]">
      <div
        className={`bg-[url('https://imgur.com/tCdXmEy.jpg')] bg-left bg-cover bg-no-repeat md:order-2 border rounded-2xl m-4 scale-x-[-1] h-56 sm:h-72 md:h-auto`}
      ></div>

      <div
        className={`bg-gradient-to-br from-fuchsia-50 to-sky-200 md:order:1 flex flex-col border rounded-2xl p-8 m-4 justify-between md:bg-gradient-to-tl`}
      >
